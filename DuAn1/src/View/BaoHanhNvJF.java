 ...
 * @author fptshop
 */
public class BaoHanhNvJF extends javax.swing.JFrame {

    /**
     * Creates new form BaoHanhNvJF
     */
    public BaoHanhNvJF() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("TÌM KIẾM PHIẾU BẢO HÀNH");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaoHanhNvJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BaoHanhNvJF().setVisible(true);
            }
        });
    }
